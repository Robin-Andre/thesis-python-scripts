...
if __name__ == "__main__":
    ...
    launch_my_algorithm(PARAMS, 2, "myalgo_10_parameters_improv_approx", descriptor="Diffseed2_2iters")
    launch_my_algorithm(PARAMS, 3, "myalgo_10_parameters_improv_approx", descriptor="Diffseed3_2Iters")
    exit(0)
