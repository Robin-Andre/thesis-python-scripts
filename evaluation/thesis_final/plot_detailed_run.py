...
def main():
    ...
    experiment_inspector.plot_subset(x, values, legend_cols=visualization.label_modes(None, get_all_and_combined=True), title="K-S", color=visualization.color_modes(None, get_all_and_combined=True))
    values = get_stochastic_tests(0, None, 1, 1)
    experiment_inspector.plot_subset(x, values, legend_cols=visualization.label_modes(None, get_all_and_combined=True), title="T-Test", color=visualization.color_modes(None, get_all_and_combined=True))
    values = get_stochastic_tests(0, None, 2, 1)
    experiment_inspector.plot_subset(x, values, legend_cols=visualization.label_modes(None, get_all_and_combined=True), title="Wilcoxon", color=visualization.color_modes(None, get_all_and_combined=True))
    #values = get_stochastic_tests(0, None, 1, 1)
    #experiment_inspector.plot_subset(x, values)
    #values = get_count_tests(3, 2, None, 1)
    #experiment_inspector.plot_subset(x, values)
